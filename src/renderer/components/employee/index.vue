<template>
  <div>
    <div class="uk-align-right">
      <button class="uk-button uk-button-primary uk-button-small" uk-toggle="target: #new-schedule" type="button">Pridėti naują</button>
    </div>
    ...
    <table class="uk-table uk-table-hover uk-table-divider">
      ...
      <tbody>
        <tr v-for="employee, index in searchFilter(employees, searchText)">
            <td>{{ index+1 }}</td>
            <td>{{ employee.name }}</td>
            ...
            <div class="uk-align-center" uk-grid>
              <form class="uk-form-horizontal uk-margin-large" @submit.prevent="addEmployee">
                ...
                <div class="uk-margin">
                  ...
                  <div class="uk-form-controls">
                    <select class="uk-select" v-model="employee.position_id">
                ...
                <div class="uk-margin">
                  ...
                  <div class="uk-form-controls">
                    <select class="uk-select" v-model="employee.schedule_id">
                      <option value="private">Asmeninis Tvarkaraštis</option>
                ...
                <div class="uk-align-right">
                  <button id="newEmployee" class="uk-button uk-button-secondary uk-button-medium uk-modal-close" type="button">Uždaryti</button>
                </div>
              </form>
            </div>
        </div>
    ...
    methods:{
      ...
      addEmployee(){
        this.$http.post('employee', this.employee).then(res => {
          ...
          this.getList()
          document.getElementById('newEmployee').click()
        }).catch(err => {
