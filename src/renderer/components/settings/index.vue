  ...
  <div>
    ...
    <div uk-grid>
      ...
      <div class="uk-width-1-3">
        ...
        <div uk-grid>
          <div class="uk-width-1-2">
            <button type="button" class="uk-button uk-button-primary uk-button-small">Išsaugoti</button>
          </div>
    ...
    <div id="holidays-modal" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            <h2 class="uk-modal-title">Išeiginės</h2>
            <form @submit.prevent="createPosition">
              ...
              <br>
              <button class="uk-button uk-button-secondary uk-button-small" type="button" v-on:click="holidaysCountUpdate(true)">Nauja pertrauka</button>
              <hr>
...
<script>
  export default{
    ...
    mounted(){
      ...
      ]).then(this.$http.spread((holidays) => {
