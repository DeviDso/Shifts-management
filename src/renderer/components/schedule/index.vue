            ...
            <div class="uk-align-center" uk-grid>
              <form class="uk-form-horizontal uk-margin-large" @submit.prevent="createSchedule">
                ...
                <div class="uk-align-left">
                  <button class="uk-button uk-button-primary" type="submit">Sukurti</button>
                </div>
                <div class="uk-align-right">
                  <button id="newScheduleClose" class="uk-button uk-button-secondary uk-modal-close" type="button">Uždaryti</button>
                </div>
              </form>
            </div>
        </div>
